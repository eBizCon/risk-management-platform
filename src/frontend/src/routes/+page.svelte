...
<div class="space-y-8" data-testid="home-page">
	<div class="text-center" data-testid="home-hero">
		...
		<p class="text-lg sm:text-xl text-secondary max-w-2xl mx-auto">
			Ihre zentrale Anlaufstelle für die Beantragung und Bearbeitung von Kreditanträgen mit
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6" data-testid="home-features">
		<div class="card p-6" data-testid="home-feature-automation">
			...
			<p class="text-secondary">
				Jeder Antrag wird automatisch bewertet und erhält einen Score von 0-100 Punkten mit
				Ampelstatus.
			</p>
		</div>
