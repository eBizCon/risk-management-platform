...
<div class="block sm:hidden space-y-3">
	{#if applications.length === 0}
		<div class="text-center text-secondary">Keine Anträge vorhanden</div>
	{:else}
...
<div class="hidden sm:block overflow-x-auto" data-testid="application-table">
				...
				<tr class="table-row" data-testid="application-row-{app.id}">
					<td class="px-4 py-4 whitespace-nowrap">
						<div
							...
							data-testid="application-customer-{app.id}"
						>
							{app.customerName ?? '-'}
						</div>
					...
					<td class="px-4 py-4 whitespace-nowrap">
						<span
							...
							class:score-high={app.score !== null && app.score >= 75}
							class:score-medium={app.score !== null && app.score >= 50 && app.score < 75}
							class:score-low={app.score !== null && app.score < 50}
							class:text-secondary={app.score === null}
						>
