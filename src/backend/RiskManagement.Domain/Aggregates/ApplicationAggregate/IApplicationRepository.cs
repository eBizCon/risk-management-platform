...
public interface IApplicationRepository
{
    ...
    Task<List<Application>> GetByUserAsync(string email, ApplicationStatus? status = null,
    ...
    Task<List<Application>> GetApplicationsForExportAsync(ApplicationStatus? status = null,
        CancellationToken ct = default);
