			...
			<div class="lg:col-span-2 space-y-6">
				...
				{#if canCreateInquiry}
					<div class="card p-6" data-testid="processor-inquiry-form-card">
						...
						<form method="POST" action="?/createInquiry" use:enhance class="space-y-4">
							<div>
								...
								></textarea>
								{#if form?.createInquiryErrors?.inquiryText}
									<p class="mt-1 error-text" data-testid="processor-inquiry-error">
										{form.createInquiryErrors.inquiryText[0]}
									</p>
								{/if}
							</div>
				...
				{#if canProcess}
					<div class="card p-6">
						...
						<form method="POST" action="?/processDecision" use:enhance class="space-y-4">
							<div>
