...
public class ScoringServiceTests
{
    ...
    {
        var result = _scoringService.CalculateScore(4000, 1500, 500, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(6000, 2000, 500, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(4000, 2200, 700, "self_employed", false);

        Assert.True(result.Score >= 50);
        Assert.True(result.Score < 75);
        Assert.Equal("yellow", result.TrafficLight);
    }

    [Fact]
    public void Should_Return_Red_TrafficLight_For_Score_Lt_50()
    {
        var result = _scoringService.CalculateScore(2500, 2000, 400, "unemployed", true);

        Assert.True(result.Score < 50);
        Assert.Equal("red", result.TrafficLight);
    }
    ...
    {
        var result = _scoringService.CalculateScore(5000, 2000, 500, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(4000, 2400, 400, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(3000, 2400, 300, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(2500, 2300, 100, "employed", false);
    ...
    {
        var employedResult = _scoringService.CalculateScore(4000, 1500, 500, "employed", false);
        var selfEmployedResult = _scoringService.CalculateScore(4000, 1500, 500, "self_employed", false);
    ...
    {
        var employedResult = _scoringService.CalculateScore(4000, 1500, 500, "employed", false);
        var retiredResult = _scoringService.CalculateScore(4000, 1500, 500, "retired", false);
    ...
    {
        var employedResult = _scoringService.CalculateScore(4000, 1500, 500, "employed", false);
        var unemployedResult = _scoringService.CalculateScore(4000, 1500, 500, "unemployed", false);
    ...
    {
        var noDefaultResult = _scoringService.CalculateScore(4000, 1500, 500, "employed", false);
        var withDefaultResult = _scoringService.CalculateScore(4000, 1500, 500, "employed", true);
    ...
    {
        var result = _scoringService.CalculateScore(4000, 1500, 500, "employed", true);
    ...
    {
        var result = _scoringService.CalculateScore(4000, 2000, 800, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(4000, 2000, 1200, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(3000, 1500, 1200, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(4000, 0, 500, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(1000, 500, 100, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(10000, 1000, 500, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(2000, 1800, 150, "unemployed", true);
    ...
    {
        var result = _scoringService.CalculateScore(5000, 2000, 600, "employed", false);
    ...
    {
        var result = _scoringService.CalculateScore(4000, 2200, 600, "self_employed", false);
